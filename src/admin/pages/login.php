...
<body class="h-full flex items-center justify-center p-4">
    <div x-data="{ email: '', password: '', name: '' }" 
         ...
         ">
        <h2 class="text-4xl font-extrabold text-white mb-6 text-center animate-pulse">Login</h2>
        ...
        <p class="text-white text-center mt-6">
            ...
            <a href="../../admin/pages/signup.php" class="font-bold hover:underline">Sign up</a>
        </p>
