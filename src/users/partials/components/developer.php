<!-- ===== Team Start ===== -->
<section id="developer" class="i pg ji gp uq">
      <!-- Bg Shapes -->
      <span class="rc h s r vd fd/5 fh rm"></span>
      <img src="<?php echo $akarUrl; ?>src/assets/images/shape-08.svg" alt="Shape Bg" class="h q r" />
      <img src="<?php echo $akarUrl; ?>src/assets/images/shape-09.svg" alt="Shape" width="5%" class="of h y z/2 " />
      <img src="<?php echo $akarUrl; ?>src/assets/images/shape-10.svg" alt="Shape" class="h _ aa" />
      <img src="<?php echo $akarUrl; ?>src/assets/images/shape-11.svg" alt="Shape" class="of h m ba" />

      <!-- Section Title Start -->
      <div
        x-data="{ sectionTitle: `Temui kami dengan Developer yang Berdedikasi`, sectionTitleText: `Kami siap mengubah setiap ide menjadi solusi nyata yang inovatif, dengan sentuhan kreativitas dan teknologi terdepan.`}">
      ...
      <div class="bb ze i va ki xn xq jb jo">
        <div class="wc qf pn xo gg cp flex flex-wrap justify-center items-center">
          <!-- Team Item -->
          <div class="animate_top rj">
            <div class="c i pg z-1">
              <img class="vd w-[360px] h-[360px] rounded-md" src="<?php echo $akarUrl; ?>src/assets/images/CodingNGamer.png" alt="Team" />
            ...
            <h4 class="yj go kk wm ob zb opacity-0">Rina Arviana</h4>
          ...
          <div class="animate_top rj">
            ...
            <h4 class="yj go kk wm ob zb">Adrian Musa Alfauzan</h4>
          ...
          <div class="animate_top rj">
            ...
            <h4 class="yj go kk wm ob zb opacity-0">Tantia Naila Khairunisa</h4>
            <p>Web Designer</p>
          </div>
          ...
          <div class="animate_top rj">
            ...
            <h4 class="yj go kk wm ob zb opacity-0">Yosua Immanuel Damanik</h4>
            <p>SDD Requirement</p>
          </div>
          ...
          <div class="animate_top rj">
            ...
            <h4 class="yj go kk wm ob zb opacity-0">Alif Syafri Putra Siswanto</h4>
            <p>SRS Requirement</p>
          </div>
