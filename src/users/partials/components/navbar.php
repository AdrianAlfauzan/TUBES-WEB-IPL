      ...
      <div class="vd to/4 tc wf yf">
        <a href="#">
          <div class="flex justify-center items-center gap-5">
            <img class="om w-14 rounded-full" src="<?php echo $akarUrl; ?>src/assets/images/CodingNGamer.png" alt="Logo Light" />
            <h3 class="om">Selamat pagi, Adrian</h3>
          </div>
          <div class="flex justify-center items-center gap-5">
            <img class="xc nm  w-14 rounded-full" src="<?php echo $akarUrl; ?>src/assets/images/CodingNGamer.png" alt="Logo Light" />
            <h3 class="xc nm">Selamat malam, Adrian</h3>
          </div>
        </a>
      ...
      <div class="vd wo/4 sd qo f ho oo wf yf" :class="{ 'd hh rm sr td ud qg ug jc yh': navigationOpen }">
        <nav>
          <ul class="tc _o sf yo cg ep">
            ...
            <li><a href="<?php echo $akarUrl; ?>src/users/pages/homepageUser.php#developer" class="xl">Developer</a></li>
          </ul>
        </nav>
        ...
        <div class="tc wf ig pb no">
          <div class="pc h io pa ra" :class="navigationOpen ? '!-ud-visible' : 'd'">
            <label class="rc ab i">
              ...
              <!-- Icon Sun -->
              <img class="xc nm " src="<?php echo $akarUrl; ?>src/assets/icon/icon-moon.svg" alt="Moon" />
            </label>
          </div>

          <a href="#" :class="{ '' : page === 'home', 'ok' : page === 'home' && stickyMenu }"
            class="text-black ">Sign In</a>
          <a href="#" :class="{ 'hh/[0.15] border border-slate-900' : page === 'home', 'sh border-none' : page === 'home' && stickyMenu }"
