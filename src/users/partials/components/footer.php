<footer>
    <div class="bb ze ki xn 2xl:ud-px-0">
      ...
      <div class="ji gp">
        <div class="tc uf ap gg fp">
          <div class="animate_top zd/2 to/4">
            <div class="inline-block">
                <div class="flex justify-center items-center gap-5">
                    <img class="om w-14 rounded-md" src="<?php echo $akarUrl; ?>src/assets/images/CodingNGamer.png" alt="Logo Light" />
                </div>
                <a href="https://www.youtube.com/@DevNGamer" class="flex justify-center items-center gap-5">
                    <img class="xc nm  w-14 rounded-md" src="<?php echo $akarUrl; ?>src/assets/images/CodingNGamer.png" alt="Logo Light" />
                    <h3 class="xc nm"> YT : DevNGamer  </h3>
                </a>
            </div>

            <p class="lc fb om">"Matikan lampu untuk melihat youtube saya."</p>
            <p class="lc fb xc nm">Silahkan ke youtube saya untuk lebih lanjut.</p>
          ...
          <div class="vd ro tc sf rn un gg vn">
            ...
            <div class="animate_top">
              <h4 class="kk wm tj ec">My Skills</h4>

              <ul>
                <li><a href="#" class="sc xl vb">Web Development</a></li>
                <li><a href="#" class="sc xl vb">Mobile Development</a></li>
                <li><a href="#" class="sc xl vb">Full Stack Developer</a></li>
                <li><a href="#" class="sc xl vb">QA / Cyber Security</a></li>
              </ul>
            </div>
            ...
            <div class="animate_top">
              ...
              <ul>
                  <li><a href="#" class="sc xl vb">Believe In Myself</a></li>
                <li><a href="#" class="sc xl vb">Syntax Squad</a></li>
                <li><a href="#" class="sc xl vb">Bhineka Dev</a></li>
              </ul>
            </div>

            <div class="animate_top">
              <h4 class="kk wm tj ec">Newsletter</h4>
              <p class="ac qe">Currently looking for a company</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <!-- Footer Bottom -->
      <div class="bh ch pm tc uf sf yo wf xf ap cg fp bj justify-center">
        <div class="animate_top">
          <p>&copy; 2025 DevNGamer.</p>
        </div>
      </div>
      <!-- Footer Bottom -->
    </div>
